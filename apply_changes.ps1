...
$navNew = "<li><a onclick=`"scrollToSection('raquetas-section')`">Raquetas</a></li><li><a onclick=`"scrollToSection('galeria-viajera')`">Galería</a></li><li><a onclick=`"scrollToSection('tienda')`">Tienda</a></li>"

$content = $content.Replace($navOld, $navNew)

$heroOld = [regex]::Match($content, '(?s)<div class="hero-logo-wrap">.*?alt="Raqueta Viajera">\s*</div>').Value
$heroNew = @"
<!-- ========================================
...
$prensaOld = [regex]::Match($content, '(?s)(<section id="prensa".*?</section>)').Value
$galeriaHtml = @"
